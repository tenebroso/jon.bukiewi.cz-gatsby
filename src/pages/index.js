...
const IndexPage = () => (
  <Layout>
    ...
    <p>I currently work for a <a href="https://www.paypal.com/" target="_blank" rel="noopener noreferrer">PayPal</a>, working alongside a team of engineers to build performant and accessible checkout features, A/B tests and GraphQl integrations using React.</p>
